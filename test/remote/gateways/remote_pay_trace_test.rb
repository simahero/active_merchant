...
class RemotePayTraceTest < Test::Unit::TestCase
  ...
  def test_successful_authorize_and_capture
    ...
    assert capture = @gateway.capture(auth.authorization, @options.merge(amount: 3.00))
  ...
  def test_successful_refund
    ...
    refund = @gateway.refund(authorization, @options.merge(amount: 2.00))
  ...
  def test_partial_refund
    ...
    refund = @gateway.refund(authorization, @options.merge(amount: 3.00))
    assert_success refund
    assert_equal 'Your transaction was successfully refunded.', refund.message
  end
